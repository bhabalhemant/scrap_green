...
class VendorChangePassword extends StatefulWidget {
  @override
  _VendorChangePasswordState createState() => _VendorChangePasswordState();
}
...
class _VendorChangePasswordState extends State<VendorChangePassword> {
  ...
  void initState() {
    ...
    BlocProvider.of<ChangePasswordBloc>(context).add(GetVendorId());
  }
      ...
      child: RaisedButton(
        ...
        onPressed: () {
          if (validate()) {
            ...
            BlocProvider.of<ChangePasswordBloc>(context).add(UpdateVendorPassword(body: body));
          }
        },
