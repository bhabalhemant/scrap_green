...
import 'package:scrap_green/models/arguments.dart';
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          Padding(
            ...
            child:Image.asset('assets/scrap_green_logo.png',
            height: 7.0,
            ...
            child: Padding(
              ...
              child: RaisedButton(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text('Check our latest rate card here',
                      style: TextStyle(
                        color: Colors.white
                      ),
                ...
                Column(
                  children: <Widget>[
                    ...
                    padding: EdgeInsets.symmetric(horizontal: 52),
                      child: GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, Constants.ROUTE_MY_CONTRIBUTION);
                      },
                        child:Card(
                          shape: RoundedRectangleBorder(
                            side: BorderSide(color: Colors.white70, width: 1),
