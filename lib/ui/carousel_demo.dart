...
class BasicDemo extends StatelessWidget {
   ...
   String header;
   String description;
   BasicDemo({this.icons, this.header, this.description});
  @override
  Widget build(BuildContext context) {
    
     List<BasicDemo> list_header = [
      BasicDemo(icons: "Icon 1", header: "Sign up", description: "Musical Event Austria"),
      BasicDemo(icons: "Icon 2", header: "Sign in", description: "Musical Event 2"),
    ];
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(currentObject.icons),
                  ),
                  
                  // Text(currentObject.header),
                  // Text(currentObject.description),
                ],
              ),
            ),
            color: Colors.green,
